...
public class Ecommerce extends Application {
    ...
    private GridPane headerBar(Button button) {
        ...
        signInButton.setStyle("-fx-background-color: #FF9900");
        ordersButton.setStyle("-fx-background-color:  #3098dc");
        cartButton.setStyle("-fx-background-color: #FFCE30");
        ...
        searchButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                // all products to show for now later will change
                bodyPane.getChildren().clear();
                root.setBackground(new Background(new BackgroundFill(Color.web("#e8f4f8"), CornerRadii.EMPTY, new Insets(0))));
                // only searched products to show
    ...
    private GridPane signupPage() {
        ...
        Paint paintLabel = Paint.valueOf("fae6ff");
        ...
        Paint paintTextfield = Paint.valueOf("ffffff");
        ...
        signupButton.setStyle("-fx-background-color: #4267B2");
    ...
    private GridPane loginPage() {
        ...
        loginButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                footerBar.add(buyNowButton, 0, 0);
                footerBar.add(addToCartButton, 1, 0);
                loginButton.setStyle("-fx-background-color: #59e547");
//                footerBar.add(placeOrderButton, 2, 0);
    ...
    private Pane createContent() {
        root = new Pane();
        root.setBackground(new Background(new BackgroundFill(Color.web("#232F38"), CornerRadii.EMPTY, new Insets(0))));//"#c0f8cb"
        root.setPrefSize(width,height + 2 * headerLine);

        addToCartButton.setStyle("-fx-background-color: #FFCE30");
        closeButton.setStyle("-fx-background-color: #E83845");
        placeOrderButton.setStyle("-fx-background-color: #3098dc");
        buyNowButton.setStyle("-fx-background-color: #FF9900");
        signOutButton.setStyle("-fx-background-color:  #E83845");


        bodyPane = new Pane();
        bodyPane.setBackground(new Background(new BackgroundFill(Color.web("#e8f4f8"), CornerRadii.EMPTY, new Insets(0))));
